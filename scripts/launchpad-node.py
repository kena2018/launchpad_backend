...
def main():
    try:         
        ...
        aws_access_key = fields.get("aws_access_key", "")
        aws_secret_key = fields.get("aws_secret_key", "")
        server_type = fields.get("server_type", "")
        container_type = fields.get("container_type", "")
        cluster_name = fields.get("cluster_name", "")
        node_group_name = fields.get("node_group_name", "")
        container_name = fields.get("container_name", "")
        service_name = fields.get("service_name", "")
        ecr_repo_name = fields.get("ecr_repo_name", "")
        region = fields.get("region", "")
        github_token = fields.get("github_token", "")
        repo_name = fields.get("repo_name", "")
        repo_owner_name = fields.get("repo_owner_name", "")
        project_technology = fields.get("project_technology", "")
        technology_version = fields.get("technology_version", "")
